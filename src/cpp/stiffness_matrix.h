#ifndef STIFFNESS_MATRIX //Bruce, avoid redefinition 
...
class StiffnessMatrix{
 public:
  ...
  StiffnessMatrix(
		  ...
		  ): _nx(nx), _nz(nz), stiff_g(nx*nz*nz,0.0) //Bruce, this is an initilizaion list. Order matters. 
    {
      stiffness_init( dx, dz, 0.0, rigidity );
    }
